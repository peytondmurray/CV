...
\vspace{-0.5cm}
\begin{longtabu} to \textwidth{X[\coll] X[\colr]}
    \textbf{Technologies} & Git, Python scientific/data vis stack (scipy [contributor], numpy, matplotlib, cython, ...). Web development with Django (and Django REST), React+Redux, AngularJS.
\end{longtabu}
