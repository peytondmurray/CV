...
\vspace{-0.5cm}
\begin{longtabu} to \textwidth{X[\coll] X[\colr]}
    \textbf{Computing} & Python (proficient), C++ (intermediate), Go (intermediate), Javascript (intermediate), CUDA (intermediate), Git (proficient)
\end{longtabu}

\vspace{-0.5cm}
\begin{longtabu} to \textwidth{X[\coll] X[\colr]}
    \textbf{Technologies} & Python scientific/data vis stack (scipy [contributor], numpy, matplotlib, cython, ...). Web development with Django (and Django REST), React, AngularJS.
\end{longtabu}
