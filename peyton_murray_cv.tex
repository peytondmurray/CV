...
\newcommand{\expvoltaiq}{
    \textbf{Voltaiq} \hfill Oct 2019 $-$ Present \newline
    \indsp \emph{Data Scientist} \newline
    \vspace{-2\topsep}
    \begin{itemize}[leftmargin=1cm]
        \item Developed bespoke analysis and visualization code to provide quantitative insight into battery performance for some of the world's largest battery manufacturers.
